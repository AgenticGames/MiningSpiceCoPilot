...
{
    /** Critical priority for tasks that affect player experience directly */
    Critical,
    
    /** High priority for visible mining operations */
    High,
    ...
    /** Minimal priority for deferred optimization */
    Minimal
};

/**
 * Task status for tracking and management
 */
...
/**
 * Task type classification for specialized handling
 */
enum class ETaskType : uint8
{
    /** General purpose task with standard handling */
    General,
